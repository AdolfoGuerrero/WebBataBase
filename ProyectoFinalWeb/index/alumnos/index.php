                        ...
                        <div class="col-lg-7 col-xl-12">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Actividad de los usuarios</h6>
                                </div>
                                
                                <div class="card-body"></div>
                                    <h1>Materias en curso</h1>
                                        <?php
                                        $sql = "SELECT materia, seccion, periodo, status_mater FROM kardex WHERE id_matricula=".$_SESSION["usuario"]." AND `status_mater` = 'En Curso'";
                                        ...
                                        echo '</table>';
                                        ?>
                                    <br><h1>Materias recomendadas</h1>
                                    <?php
                                        $sql = "SELECT materia, seccion, periodo, status_mater FROM kardex WHERE id_matricula=".$_SESSION["usuario"]." AND `status_mater` = 'Pendiente Por Cursar' AND `sem` = '4'";
                                        $result = $conn->query($sql);
                                        if ($result->num_rows > 0) {
                                        echo'<table border="1">';
                                        echo "<td bgcolor=#4E4EEF style=color:black>Materia</td>";
